...
// `remediationLessonId` aponta para a primeira aula substantiva já existente
// no módulo. O laboratório usa esse destino para revisão geral do módulo; não
// o apresenta como se fosse uma fonte específica de cada decisão do cenário.
export const tracks = [
  {id:'m00',remediationLessonId:'pop-section-001',code:'M00',title:'Orientação, escopo e controle documental',sections:['Controle documental','1'],icon:'Compass',color:'#3b8070',summary:'Como usar o POP, entender seu alcance e reconhecer os limites da atuação técnica.'},
  {id:'m01',remediationLessonId:'pop-section-004',code:'M01',title:'Papéis, normas, definições e método obrigatório',sections:['2','3','4','5'],icon:'Scale',color:'#1769c2',summary:'Competências, ordem de consulta, transições, conceitos e sequência rastreável de decisão.'},
  {id:'m02',remediationLessonId:'pop-section-015',code:'M02',title:'Fluxo geral, recebimento e triagem',sections:['6','7'],icon:'Inbox',color:'#0a7755',summary:'Leitura cronológica e temática, conferência inicial e saídas possíveis da triagem.'},
  {id:'m03',remediationLessonId:'pop-section-020',code:'M03',title:'Enquadramento e Consulta Prévia',sections:['8','9'],icon:'GitBranch',color:'#1769c2',summary:'Tipologia, potência, alagamento, IDA, sensibilidade, estudo e cenários da Consulta Prévia.'},
  {id:'m04',remediationLessonId:'pop-section-028',code:'M04',title:'DLAM, LAC e LAS',sections:['10'],icon:'FileCheck',color:'#2e8263',summary:'Dispensa, adesão e compromisso, licenciamento simplificado e seus limites.'},
  {id:'m05',remediationLessonId:'pop-section-033',code:'M05',title:'Licenciamento trifásico: LP, LI e LO',sections:['11'],icon:'Milestone',color:'#146b51',summary:'Finalidade, documentos, mérito e produtos técnicos de cada fase do rito trifásico.'},
  {id:'m06',remediationLessonId:'pop-section-041',code:'M06',title:'AA, renovação, regularização, transferência e alterações',sections:['12','13','14','15'],icon:'RefreshCw',color:'#b57b08',summary:'Situações transitórias e especiais, sem misturar objetos, títulos ou fases.'},
  {id:'m07',remediationLessonId:'pop-section-051',code:'M07',title:'Sistemas associados e segurança de barragens',sections:['16','17'],icon:'ShieldCheck',color:'#2c718d',summary:'Áreas de apoio, linhas e acessos, PNSB, PSB, PAE, ZAS e interfaces de competência.'},
  {id:'m08',remediationLessonId:'pop-section-057',code:'M08',title:'Memorial e estudos ambientais',sections:['18'],icon:'Files',color:'#4f6f5f',summary:'Memorial, PCA, RAS, RDPA, EIA, RIMA, PBA e demais estudos, com critérios de suficiência.'},
  {id:'m09',remediationLessonId:'pop-section-067',code:'M09',title:'PACUERA integral',sections:['18.10'],icon:'Map',color:'#0f79a8',summary:'Exigibilidade, TR, diagnóstico, UTHs, zoneamento, participação social, implementação e revisão.'},
  {id:'m10',remediationLessonId:'pop-section-076',code:'M10',title:'Cartografia, APP, flora, fauna e recursos hídricos',sections:['19'],icon:'Trees',color:'#278454',summary:'Base espacial da análise e verificações ambientais integradas.'},
  {id:'m11',remediationLessonId:'pop-section-082',code:'M11',title:'ANEEL, IPHAN, município e vistoria',sections:['20','21'],icon:'Building2',color:'#795e2e',summary:'Interfaces institucionais, limites de competência e evidência de campo.'},
  {id:'m15',remediationLessonId:'pop-section-027',code:'M12',title:'Unidades de conservação, APAs e Planos de Manejo',sections:['20.2','9.2'],icon:'Trees',color:'#2f9e6e',summary:'Triagem e análise de UC e APA por fase, Plano de Manejo, GeoPR e o caso da Escarpa Devoniana.'},
  {id:'m16',remediationLessonId:'pop-section-143',code:'M13',title:'Licenciamento federal delegado: ACT e RTAA',sections:['20.6','Anexo F'],icon:'FileCheck',color:'#1f7fb8',summary:'Competência delegada ao IAT, leitura do ACT, obrigações do delegatário e o relatório anual de atividades.'},
  {id:'m12',remediationLessonId:'pop-section-089',code:'M14',title:'Suficiência, pendências, condicionantes e conclusão',sections:['22','23','24','25'],icon:'ClipboardCheck',color:'#0b6553',summary:'Da matriz documental à manifestação conclusiva, com linguagem proporcional e verificável.'},
  {id:'m13',remediationLessonId:'pop-section-099',code:'M15',title:'Formatação, qualidade e rastreabilidade',sections:['26','27'],icon:'BadgeCheck',color:'#426a91',summary:'Padrão documental, revisão, evidências, consistência interna e controle final.'},
  {id:'m14',remediationLessonId:'pop-section-110',code:'M16',title:'Anexos, referências e caso integrador',sections:['Anexo A','Anexo B','Anexo C','Anexo D','Anexo E','Referências'],icon:'Library',color:'#6c7049',summary:'Modelos reutilizáveis, siglas, referências e consolidação do percurso.'},
];
...
export const featuredMedia = {
  ...
  m15: { src: '/media/m15.mp4', poster: '/media/m15-poster.png', captions: '/media/m15.vtt', title: "Unidades de conservação e APAs" },
...
export const flowSpecs = [
  ...
  {id:'las',track:'m04',title:'Licença Ambiental Simplificada',imageNumber:3,nodes:['Receber requerimento','Conferir enquadramento','Analisar RAS e documentos','Complementação?','Concluir análise','Encaminhar decisão']},
  {id:'lp',track:'m05',title:'Licença Prévia',imageNumber:4,nodes:['Receber LP','Conferir estudo exigível','Analisar localização e concepção','Avaliar viabilidade','Elaborar parecer','Encaminhar decisão']},
...
export const trackGroups = [
  ...
  {title:'Enquadramento e modalidades',ids:['m03','m04','m05','m06']},
  {title:'Interfaces e estudos',ids:['m07','m08','m09','m10','m11','m15','m16']},
  {title:'Decisão e qualidade',ids:['m12','m13','m14']},
];
