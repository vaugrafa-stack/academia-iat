...
export const QUESTOES_EXTRA = [
  ...
  ['m00', 'De onde deve decorrer uma exigência documental feita ao empreendedor?',
    ['Do próprio POP, que a cria quando necessário', 'Da norma aplicável, do Termo de Referência, do SGA, de condicionante anterior, de fato novo ou de inconsistência', 'Da praxe da equipe que analisa o processo'], 1,
  ...
  ['m01', 'Na ordem operacional de consulta, qual é a posição do Termo de Referência frente à lei?',
    ['O TR prevalece, por ser mais específico', 'O TR detalha a instrução do caso, mas não prevalece sobre lei ou regulamento', 'TR e lei têm exatamente a mesma força'], 1,
  ...
  ['m04', 'A exceção federal do art. 22 da Lei nº 15.190/2025 para APA torna a LAC cabível no regime estadual?',
    ['Sim, a norma federal prevalece automaticamente', 'Não; o critério estadual mais restritivo do art. 64, I, e, impede a LAC em UC, inclusive APA', 'Sim, quando o Plano de Manejo for omisso'], 1,
  ...
  ['m04', 'Quais critérios a IN IAT nº 09/2025 prevê para LAC de CGH?',
    ['Potência até 3 MW e alagamento inferior a 13 ha', 'Potência de até 1 MW, alagamento inferior a 5 ha e IDA menor que 3', 'Qualquer potência, desde que sem supressão'], 1,
    'Esses são apenas os critérios tipológicos de entrada: a modalidade ainda depende dos critérios gerais e da compatibilidade territorial.',
    { sec: 'pop-section-030', quote: 'LAC para potência de até 1 MW, alagamento inferior a 5 ha, IDA menor que 3' }],
  ...
  ['m05', 'Em que hipóteses o POP indica exigência de EIA e RIMA para PCH?',
    ['Em toda PCH, sem exceção', 'Nas PCHs com potência acima de 10 MW ou alagamento superior a 100 ha', 'Somente quando houver supressão de vegetação nativa'], 1,
    'A exigência também alcança as UHEs e os empreendimentos inicialmente simplificados que o IAT considere potencialmente impactantes.',
    { sec: 'pop-section-034', quote: 'às PCHs com potência acima de 10 MW ou alagamento superior a 100 ha' }],
  ...
  ['m06', 'Qual prazo a Lei Federal nº 15.190/2025 estabelece para decidir o pedido de alteração de titularidade?',
    ['Até 15 dias', 'Até 30 dias, sem majorar condicionantes quando não houver incremento de impactos', 'Até 120 dias, prorrogáveis'], 1,
  ...
  ['m07', 'A incidência da Política Nacional de Segurança de Barragens decorre da classificação do empreendimento?',
    ['Sim; toda PCH e UHE está sujeita à PNSB', 'Não; a incidência se verifica pelas características e critérios legais da estrutura', 'Sim, mas apenas para UHE'], 1,
  ...
  ['m07', 'O que a manifestação do licenciamento não deve declarar sobre a barragem?',
    ['A consequência ambiental identificada', 'Estabilidade, segurança estrutural ou atendimento definitivo de obrigação de outro órgão', 'Os limites da própria análise'], 1,
  ...
  ['m08', 'Um estudo ambiental atualizado supre um Memorial Descritivo desatualizado?',
    ['Sim, se o estudo descrever o arranjo atual', 'Não; estudo ambiental antigo não corrige memorial desatualizado', 'Sim, desde que haja ART do estudo'], 1,
  ...
  ['m09', 'Qual escala preferencial o TR estabelece para os produtos temáticos do PACUERA?',
    ['Até 1:100.000', 'Até 1:25.000, admitida exceção tecnicamente justificada', 'Até 1:250.000'], 1,
  ...
  ['m10', 'O que o material cartográfico deve conter, conforme a fase e a complexidade do arranjo?',
    ['Apenas escala e legenda', 'Título, legenda, escala, orientação, projeção, datum, data e responsável técnico', 'Somente as coordenadas do barramento'], 1,
  ...
  ['m10', 'Qual norma o POP indica para os estudos de fauna?',
    ['IN IAT nº 01/2023, ainda vigente', 'Portaria IAT nº 012, de 10 de janeiro de 2024, com atenção ao Anexo II', 'Resolução CONAMA nº 428/2010'], 1,
  ...
  ['m11', 'Qual é o gatilho de entorno para ciência ao órgão gestor da UC em processos não sujeitos a EIA/RIMA?',
    ['Até quinhentos metros', 'Até dois mil metros, quando a zona de amortecimento não tenha sido estabelecida', 'Até dez quilômetros, em qualquer caso'], 1,
  ...
  ['m14', 'Restrição material do Plano de Manejo que torna a localização incompatível pode virar condicionante?',
    ['Sim, com prazo para adequação do projeto', 'Não; os modelos do anexo só servem quando o empreendimento é compatível com a norma territorial', 'Sim, quando o empreendedor concordar'], 1,
