...
export const QUESTOES_EXTRA = [
  ...
  ['m04', 'A exceção federal do art. 22 da Lei nº 15.190/2025 para APA torna a LAC cabível no regime estadual?',
    ['Sim; a exceção federal para APA afasta automaticamente o critério estadual mais restritivo, mesmo quando o decreto estadual inclui a APA entre as UCs impeditivas', 'Não; o critério estadual mais restritivo do art. 64, I, e, impede a LAC em UC, inclusive APA', 'Sim; a LAC volta a ser possível quando o Plano de Manejo for omisso sobre hidrelétricas, independentemente da vedação estadual por localização em UC'], 1,
  ...
  ['m08', 'Um estudo ambiental antigo supre um Memorial Descritivo desatualizado?',
    ['Sim, se o estudo descrever ao menos parte do arranjo', 'Não; estudo ambiental antigo não corrige memorial desatualizado', 'Sim, desde que o estudo tenha ART válida'], 1,
  ...
  ['m13', 'Em que consiste o controle visual obrigatório do DOCX antes da entrega?',
    ['Revisar o texto extraído em busca de erros de digitação', 'Renderizar para PDF ou imagens e inspecionar todas as páginas', 'Conferir apenas a primeira e a última página'], 1,
